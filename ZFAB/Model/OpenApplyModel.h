...
@interface OpenApplyModel : NSObject
...
@property (nonatomic, strong) NSString *bankName;  //银行账户名
@property (nonatomic, strong) NSString *bankNumber;    //银行卡号
@property (nonatomic, strong) NSString *bankAccount;   //银行代码
