//
//  ProcurementBuyOrderController.m
//  ZFAB
//
...
@interface ProcurementBuyOrderController ()<UITextFieldDelegate>
...
@implementation ProcurementBuyOrderController
...
- (void)createOrderForProcurementBuy {
...
- (CGFloat)getSummaryPrice {
    return (_goodDetail.procurementPrice + _goodDetail.defaultChannel.openCost) * _count;
}
...
- (IBAction)ensureOrder:(id)sender {
    ...
    [self createOrderForProcurementBuy];
}
